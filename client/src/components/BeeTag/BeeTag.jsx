  ...
  return (
    <MDBContainer id="beetag">
      <MDBTooltip domElement tag="span" placement="top">
        <span id="badge-yellow" className="tag badge badge-warning">
          <i className="fab fa-forumbee" aria-hidden="true"></i>
          {playerName}
        </span>
          ...
          <div id="beetag-tags" className="d-flex">
            ...
            {averageRankedAccuracy && (
              <MDBBadge color="light">
                ...
                {averageRankedAccuracy.toFixed(2)}%
              </MDBBadge>
            )}
            {totalPlayCount && (
              <MDBBadge color="light">
            ...
            {lastPlayedSong && (
              <div id="last-played">
                <MDBBadge color="dark">
                  ...
                  <MDBIcon icon="music" />
                  <img
                    src={parseSongPicUrl(lastPlayedSong.songHash)}
                    alt="Last played song"
                  />
                  <p>
                    {lastPlayedSong.songName} by {lastPlayedSong.songAuthorName}
                  </p>
                </MDBBadge>
              </div>
            )}
